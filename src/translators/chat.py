...
class ChatTranslator(BaseTranslator[
    ...
    def translate_request(
        self, 
        ollama_request: Union[OllamaGenerateRequest, OllamaChatRequest]
    ) -> OpenAIChatRequest:
        """
        ...
        try:
            ...
            self.logger.debug(
                f"Translated Ollama request to OpenAI format",
                extra={
                    "extra_data": {
                        "model": model,
    ...
    def translate_response(
        ...
        try:
            ...
            if isinstance(openai_response, OpenAIStreamResponse):
                return self._translate_streaming_response(openai_response, original_request)
            
            # Handle non-streaming response
            return self._translate_non_streaming_response(openai_response, original_request)
        ...
        try:
            ...
            if isinstance(openai_chunk, str):
                ...
                try:
                    ...
                    self.logger.warning(f"Failed to parse streaming chunk: {openai_chunk}")
                    return None
    ...
    def _validate_ollama_request(
        self, 
        request: Union[OllamaGenerateRequest, OllamaChatRequest]
    ) -> None:
        """
