...
class RetryClient:
    ...
    def _should_retry(self, response: Optional[httpx.Response], error: Optional[Exception]) -> bool:
        ...
        if response:
            ...
            return response.status_code >= 500 or response.status_code in [429, 408, 425]
    ...
    async def request_with_retry(
        ...
        method: str,
        url: str,
        retry_on: Optional[Callable[[Optional[httpx.Response], Optional[Exception]], bool]] = None,
        **kwargs
    ) -> httpx.Response:
