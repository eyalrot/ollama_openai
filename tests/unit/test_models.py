...
class TestOllamaModels:
    ...
    def test_ollama_chat_message(self):
        ...
        msg_with_images = OllamaChatMessage(
            role="user", content="What's in this image?", images=["base64encodedimage"]
        )
    ...
    def test_ollama_generate_request(self):
        ...
        req = OllamaGenerateRequest(model="llama2", prompt="Tell me a story")
        assert req.model == "llama2"
...
class TestOpenAIModels:
    ...
    def test_openai_message(self):
        ...
        # With name
        msg_with_name = OpenAIMessage(role="user", content="Hi", name="john")
...
class TestModelListingModels:
    ...
    def test_model_info_with_details(self):
        ...
        info = ModelInfo(
            ...
            details={"format": "gguf", "family": "mistral", "parameter_size": "7B"},
        )
