...
class TestTranslator(BaseTranslator[Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any]]):
    ...
    def translate_request(self, ollama_request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"translated": True, "model": self.map_model_name(ollama_request.get("model", ""))}
...
class TestBaseTranslator:
    ...
    def test_initialization_from_config(self):
        ...
        with patch('src.translators.base.get_settings') as mock_settings:
            mock_settings.return_value.load_model_mappings.return_value = {"mistral": "gpt-3.5-turbo"}
...
class TestIntegration:
    ...
    def test_streaming_translation_flow(self):
        ...
        result1 = translator.translate_streaming_response(chunk1, original_request, is_first_chunk=True)
        ...
        result3 = translator.translate_streaming_response(chunk3, original_request, is_last_chunk=True)
