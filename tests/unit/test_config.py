...
class TestSettings:
    ...
    def test_missing_required_fields(self):
        ...
        with patch("src.config.Settings.model_config", {"env_file": None, "case_sensitive": True, "extra": "ignore"}):
            ...
            with patch.dict(os.environ, {"OPENAI_API_BASE_URL": "https://api.test.com"}, clear=True):
                with pytest.raises(ValidationError) as exc_info:
                    Settings()
    ...
    def test_load_model_mappings(self):
        ...
        try:
            ...
            with patch.dict(os.environ, env, clear=True):
                ...
                assert mappings["llama2"] == "my-custom-llama2"  # Custom overrides default
                assert mappings["mistral"] == "mistralai/Mistral-7B-Instruct-v0.1"  # Default still present
        finally:
            os.unlink(temp_file)
    ...
    def test_get_mapped_model_name(self):
        ...
        with patch.dict(os.environ, base_env, clear=True):
            ...
            # Test model variants
            assert settings.get_mapped_model_name("llama2:13b") == "meta-llama/Llama-2-13b-chat-hf"
...
"""
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.dict(os.environ, {}, clear=True):
                ...
                assert str(settings.OPENAI_API_BASE_URL) == "https://env-file-test.com/v1"
