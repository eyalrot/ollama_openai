...
llm = Ollama(base_url=PROXY_BASE_URL, model="gpt-3.5-turbo")
...
print("\n=== Chat Model Example ===")
chat = ChatOllama(base_url=PROXY_BASE_URL, model="gpt-3.5-turbo")
...
prompt = PromptTemplate(
    input_variables=["profession", "question", "style"], template=template
)
...
try:
    custom_llm = Ollama(
        base_url=PROXY_BASE_URL, model="llama2"  # This will be mapped to actual model
    )
